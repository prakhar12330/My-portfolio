...
const Testimonials = () => {
  const testimonials = [
    {
      ...
      name: '14 AI Innovation, Inc',
      role: 'Front-End Web Developer',
      test: 'Was Engaged in a Space and Defence Startup. My Responsibilities included developing, designing, and planning the frontend architecture of a database management and visualization tool.',
    },
    // {
    //   id: 2,
  ...
  return (
    <section id="testmonials">
      <h5>Industry Experience I Hold</h5>
      <h2>Experience</h2>
      <Swiper 
        ...
        {testimonials.map((test) => (
          ...
          <h4 className='client__name'>{test.name}</h4>
